...
import { getMaintenanceTicketById, getMaintenanceTicketPage } from '@/api/maintenanceTicket'
...
async function loadPage() {
  ...
  try {
    ...
    if (!e?.elMessageNotified) ElMessage.error('获取工单查询列表失败')
  } finally {
    loading.value = false
  }
}
